...
function si_section_action( $attr ){
    ...
    return '<section class="section actions-posts mt-40 mb-0" style="background: url(https://spb-dips.com/wp-content/themes/education-hub/assets/img/content-action-bg.jpg); background-repeat: no-repeat;background-position: center top;">
    <div class="content-action">
      ...
      <div class="content-action-container">
        <div class="content-action-item">Заказывая у нас несколько документов в рамках одного заказа, вы получите скидку в 2000 рублей.</div>
        <div class="content-action-item">Мы ценим постоянных клиентов и предлагаем для них специальную скидку в 2000 рублей за любой повторный заказ.</div>
        <div class="content-action-item">Также наша компания предлагает уникальную акцию только в день рождения клиента. В день праздника, за три дня и три дня после него будет действовать разовая скидка на 1000 рублей на любой заказ при подтверждении даты.</div>
      </div>
    </div>
  </section>';
}
